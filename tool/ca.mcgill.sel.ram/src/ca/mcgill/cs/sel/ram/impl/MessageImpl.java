 ...
 * <ul>
 *   <li>{@link ca.mcgill.cs.sel.ram.impl.MessageImpl#getSendEvent <em>Send Event</em>}</li>
 *   <li>{@link ca.mcgill.cs.sel.ram.impl.MessageImpl#getReceiveEvent <em>Receive Event</em>}</li>
 *   <li>{@link ca.mcgill.cs.sel.ram.impl.MessageImpl#getSignature <em>Signature</em>}</li>
 *   <li>{@link ca.mcgill.cs.sel.ram.impl.MessageImpl#getAssignTo <em>Assign To</em>}</li>
 *   <li>{@link ca.mcgill.cs.sel.ram.impl.MessageImpl#getMessageSort <em>Message Sort</em>}</li>
 *   <li>{@link ca.mcgill.cs.sel.ram.impl.MessageImpl#getArguments <em>Arguments</em>}</li>
 *   <li>{@link ca.mcgill.cs.sel.ram.impl.MessageImpl#getInteraction <em>Interaction</em>}</li>
 *   <li>{@link ca.mcgill.cs.sel.ram.impl.MessageImpl#getReturns <em>Returns</em>}</li>
 *   <li>{@link ca.mcgill.cs.sel.ram.impl.MessageImpl#isSelfMessage <em>Self Message</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
