 ...
 * <ul>
 *   <li>{@link ca.mcgill.cs.sel.ram.impl.LiteralBooleanImpl#isValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LiteralBooleanImpl extends LiteralSpecificationImpl implements LiteralBoolean {
    ...
    protected EClass eStaticClass() {
        return RamPackage.Literals.LITERAL_BOOLEAN;
    }
    ...
    public void setValue(boolean newValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RamPackage.LITERAL_BOOLEAN__VALUE, oldValue, value));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case RamPackage.LITERAL_BOOLEAN__VALUE:
                return isValue();
        }
