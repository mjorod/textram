 ...
 * <ul>
 *   <li>{@link ca.mcgill.cs.sel.ram.impl.ReferenceImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReferenceImpl extends PropertyImpl implements Reference {
    ...
    protected EClass eStaticClass() {
        return RamPackage.Literals.REFERENCE;
    }
        ...
        if (type != null && type.eIsProxy()) {
            ...
            if (type != oldType) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, RamPackage.REFERENCE__TYPE, oldType, type));
            }
        }
        return type;
    }
    ...
    public void setType(ObjectType newType) {
        ...
        type = newType;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RamPackage.REFERENCE__TYPE, oldType, type));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case RamPackage.REFERENCE__TYPE:
