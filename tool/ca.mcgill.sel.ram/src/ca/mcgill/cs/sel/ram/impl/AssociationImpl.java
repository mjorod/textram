 ...
 * <ul>
 *   <li>{@link ca.mcgill.cs.sel.ram.impl.AssociationImpl#getEnds <em>Ends</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AssociationImpl extends NamedElementImpl implements Association {
	...
	protected EClass eStaticClass() {
        return RamPackage.Literals.ASSOCIATION;
    }
	...
	public EList<AssociationEnd> getEnds() {
        if (ends == null) {
            ends = new EObjectWithInverseResolvingEList<AssociationEnd>(AssociationEnd.class, this, RamPackage.ASSOCIATION__ENDS, RamPackage.ASSOCIATION_END__ASSOC);
        }
        return ends;
    }
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case RamPackage.ASSOCIATION__ENDS:
