 ...
 * <ul>
 *   <li>{@link ca.mcgill.cs.sel.ram.impl.ImplementationClassImpl#getInstanceClassName <em>Instance Class Name</em>}</li>
 *   <li>{@link ca.mcgill.cs.sel.ram.impl.ImplementationClassImpl#isInterface <em>Interface</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ImplementationClassImpl extends ClassifierImpl implements ImplementationClass {
    ...
    public void setInterface(boolean newInterface) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RamPackage.IMPLEMENTATION_CLASS__INTERFACE, oldInterface, interface_));
    }
