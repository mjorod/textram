 ...
 * <ul>
 *   <li>{@link ca.mcgill.cs.sel.ram.impl.ContainerMapImpl#getTypedKey <em>Key</em>}</li>
 *   <li>{@link ca.mcgill.cs.sel.ram.impl.ContainerMapImpl#getTypedValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ContainerMapImpl extends EObjectImpl implements BasicEMap.Entry<EObject,EMap<EObject, LayoutElement>> {
    /**
    ...
    protected EClass eStaticClass() {
        return RamPackage.Literals.CONTAINER_MAP;
    }
        ...
        if (key != null && key.eIsProxy()) {
            ...
            if (key != oldKey) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, RamPackage.CONTAINER_MAP__KEY, oldKey, key));
            }
        }
        return key;
    }
    ...
    public void setTypedKey(EObject newKey) {
        ...
        key = newKey;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RamPackage.CONTAINER_MAP__KEY, oldKey, key));
    }
    ...
    public EMap<EObject, LayoutElement> getTypedValue() {
        if (value == null) {
            value = new EcoreEMap<EObject,LayoutElement>(RamPackage.Literals.ELEMENT_MAP, ElementMapImpl.class, this, RamPackage.CONTAINER_MAP__VALUE);
        }
        return value;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case RamPackage.CONTAINER_MAP__VALUE:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case RamPackage.CONTAINER_MAP__KEY:
