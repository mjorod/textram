 ...
 * <ul>
 *   <li>{@link ca.mcgill.cs.sel.ram.Message#getSendEvent <em>Send Event</em>}</li>
 *   <li>{@link ca.mcgill.cs.sel.ram.Message#getReceiveEvent <em>Receive Event</em>}</li>
 *   <li>{@link ca.mcgill.cs.sel.ram.Message#getSignature <em>Signature</em>}</li>
 *   <li>{@link ca.mcgill.cs.sel.ram.Message#getAssignTo <em>Assign To</em>}</li>
 *   <li>{@link ca.mcgill.cs.sel.ram.Message#getMessageSort <em>Message Sort</em>}</li>
 *   <li>{@link ca.mcgill.cs.sel.ram.Message#getArguments <em>Arguments</em>}</li>
 *   <li>{@link ca.mcgill.cs.sel.ram.Message#getInteraction <em>Interaction</em>}</li>
 *   <li>{@link ca.mcgill.cs.sel.ram.Message#getReturns <em>Returns</em>}</li>
 *   <li>{@link ca.mcgill.cs.sel.ram.Message#isSelfMessage <em>Self Message</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.mcgill.cs.sel.ram.RamPackage#getMessage()
...
public interface Message extends EObject {
     ...
     * @see ca.mcgill.cs.sel.ram.RamPackage#getMessage_SendEvent()
     * @model required="true"
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link ca.mcgill.cs.sel.ram.Message#getSendEvent <em>Send Event</em>}' reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see ca.mcgill.cs.sel.ram.RamPackage#getMessage_ReceiveEvent()
     * @model required="true"
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link ca.mcgill.cs.sel.ram.Message#getReceiveEvent <em>Receive Event</em>}' reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see ca.mcgill.cs.sel.ram.RamPackage#getMessage_Signature()
     * @model required="true"
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link ca.mcgill.cs.sel.ram.Message#getSignature <em>Signature</em>}' reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see ca.mcgill.cs.sel.ram.RamPackage#getMessage_AssignTo()
     * @model
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link ca.mcgill.cs.sel.ram.Message#getAssignTo <em>Assign To</em>}' reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * The literals are from the enumeration {@link ca.mcgill.cs.sel.ram.MessageSort}.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see ca.mcgill.cs.sel.ram.RamPackage#getMessage_MessageSort()
     * @model required="true"
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link ca.mcgill.cs.sel.ram.Message#getMessageSort <em>Message Sort</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * The list contents are of type {@link ca.mcgill.cs.sel.ram.ParameterValueMapping}.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see ca.mcgill.cs.sel.ram.RamPackage#getMessage_Arguments()
     ...
     * It is bidirectional and its opposite is '{@link ca.mcgill.cs.sel.ram.Interaction#getMessages <em>Messages</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see ca.mcgill.cs.sel.ram.RamPackage#getMessage_Interaction()
    ...
    /**
     * Sets the value of the '{@link ca.mcgill.cs.sel.ram.Message#getInteraction <em>Interaction</em>}' container reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see ca.mcgill.cs.sel.ram.RamPackage#getMessage_Returns()
    ...
    /**
     * Sets the value of the '{@link ca.mcgill.cs.sel.ram.Message#getReturns <em>Returns</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see ca.mcgill.cs.sel.ram.RamPackage#getMessage_SelfMessage()
