 ...
 * <ul>
 *   <li>{@link ca.mcgill.cs.sel.ram.impl.AspectImpl#getStructuralView <em>Structural View</em>}</li>
 *   <li>{@link ca.mcgill.cs.sel.ram.impl.AspectImpl#getMandatoryAspectParameters <em>Mandatory Aspect Parameters</em>}</li>
 *   <li>{@link ca.mcgill.cs.sel.ram.impl.AspectImpl#getMessageViews <em>Message Views</em>}</li>
 *   <li>{@link ca.mcgill.cs.sel.ram.impl.AspectImpl#getInstantiations <em>Instantiations</em>}</li>
 *   <li>{@link ca.mcgill.cs.sel.ram.impl.AspectImpl#getLayout <em>Layout</em>}</li>
 *   <li>{@link ca.mcgill.cs.sel.ram.impl.AspectImpl#getStateViews <em>State Views</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
