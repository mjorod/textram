 ...
 * <ul>
 *   <li>{@link ca.mcgill.cs.sel.ram.Parameter#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.mcgill.cs.sel.ram.RamPackage#getParameter()
...
public interface Parameter extends TypedElement, MappableElement {
     ...
     * @see #setType(Type)
     * @see ca.mcgill.cs.sel.ram.RamPackage#getParameter_Type()
     * @model required="true"
     * @generated
     */
	Type getType();
	...
	/**
     * Sets the value of the '{@link ca.mcgill.cs.sel.ram.Parameter#getType <em>Type</em>}' reference.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
