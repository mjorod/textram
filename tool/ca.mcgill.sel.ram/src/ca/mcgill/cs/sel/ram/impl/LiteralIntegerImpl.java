 ...
 * <ul>
 *   <li>{@link ca.mcgill.cs.sel.ram.impl.LiteralIntegerImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LiteralIntegerImpl extends LiteralSpecificationImpl implements LiteralInteger {
    ...
    protected EClass eStaticClass() {
        return RamPackage.Literals.LITERAL_INTEGER;
    }
    ...
    public void setValue(int newValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RamPackage.LITERAL_INTEGER__VALUE, oldValue, value));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case RamPackage.LITERAL_INTEGER__VALUE:
                return getValue();
        }
