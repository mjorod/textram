 ...
 * <ul>
 *   <li>{@link ca.mcgill.cs.sel.ram.impl.TypeParameterImpl#getGenericType <em>Generic Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TypeParameterImpl extends TypeImpl implements TypeParameter {
    ...
    protected EClass eStaticClass() {
        return RamPackage.Literals.TYPE_PARAMETER;
    }
        ...
        if (genericType != null && genericType.eIsProxy()) {
            ...
            if (genericType != oldGenericType) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, RamPackage.TYPE_PARAMETER__GENERIC_TYPE, oldGenericType, genericType));
            }
        }
        return genericType;
    }
    ...
    public void setGenericType(ObjectType newGenericType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RamPackage.TYPE_PARAMETER__GENERIC_TYPE, oldGenericType, genericType));
    }
