...
public class TextRAMTransform implements ITextRAMTransform {
  ...
  public TAspect transform(final Aspect ramAspect) {
    final TAspect textRamAspect = TextRamFactory.eINSTANCE.createTAspect();
  ...
  private boolean transformStructuralView(final StructuralView from, final TAspect to) {
    boolean _xblockexpression = false;
    {
      ...
      _xblockexpression = _classes.addAll(_transformClasses);
    }
    ...
    List<TClass> _xblockexpression = null;
    {
      ...
      final Procedure1<Classifier> _function = new Procedure1<Classifier>() {
        public void apply(final Classifier c) {
          TClass _transformClass = TextRAMTransform.this.transformClass(c, to);
